...
class OpenRouterProvider(BaseAIProvider):
    ...
    def __init__(self, model=None, temperature=0.7, max_tokens=None, stream=False):
        ...
        self.base_url = get_openrouter_base_url().rstrip("/")
        self.app_name = get_openrouter_app_name()
        self.site_url = get_openrouter_site_url()
    ...
    def generate_response(self, prompt, system_prompt=None, context=None):
        if not self.api_key:
            raise RuntimeError("OpenRouter provider is not configured. Missing OPENROUTER_API_KEY.")
            ...
            try:
                ...
                response = httpx.post(
                    ...
                    headers={
                        ...
                        "HTTP-Referer": self.site_url or "https://render.com",
