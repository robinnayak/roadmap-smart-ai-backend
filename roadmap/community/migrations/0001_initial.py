    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('meetup', 'Meetup'), ('webinar', 'Webinar'), ('challenge', 'Challenge'), ('workshop', 'Workshop')], default='meetup', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change', models.CharField(choices=[('up', 'Up'), ('down', 'Down'), ('same', 'Same')], default='same', max_length=10)),
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('general', 'General'), ('goals', 'Goals'), ('routines', 'Routines'), ('habits', 'Habits'), ('motivation', 'Motivation'), ('achievements', 'Achievements'), ('questions', 'Questions')], default='general', max_length=30)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['category', 'last_activity'], name='community_d_categor_c9fc16_idx'), models.Index(fields=['is_pinned', 'is_hot'], name='community_d_is_pinn_d13997_idx')],
            },
        ),
    ]
